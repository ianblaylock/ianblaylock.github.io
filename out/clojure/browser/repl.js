...
var seq__1027_1031 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__1028_1032 = null;
var count__1029_1033 = (0);
var i__1030_1034 = (0);
while(true){
if((i__1030_1034 < count__1029_1033)){
var str_1035 = cljs.core._nth.call(null,chunk__1028_1032,i__1030_1034);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1035})));


var G__1036 = seq__1027_1031;
var G__1037 = chunk__1028_1032;
var G__1038 = count__1029_1033;
var G__1039 = (i__1030_1034 + (1));
seq__1027_1031 = G__1036;
chunk__1028_1032 = G__1037;
count__1029_1033 = G__1038;
i__1030_1034 = G__1039;
continue;
} else {
var temp__5535__auto___1040 = cljs.core.seq.call(null,seq__1027_1031);
if(temp__5535__auto___1040){
var seq__1027_1041__$1 = temp__5535__auto___1040;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1027_1041__$1)){
var c__4958__auto___1042 = cljs.core.chunk_first.call(null,seq__1027_1041__$1);
var G__1043 = cljs.core.chunk_rest.call(null,seq__1027_1041__$1);
var G__1044 = c__4958__auto___1042;
var G__1045 = cljs.core.count.call(null,c__4958__auto___1042);
var G__1046 = (0);
seq__1027_1031 = G__1043;
chunk__1028_1032 = G__1044;
count__1029_1033 = G__1045;
i__1030_1034 = G__1046;
continue;
} else {
var str_1047 = cljs.core.first.call(null,seq__1027_1041__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1047})));


var G__1048 = cljs.core.next.call(null,seq__1027_1041__$1);
var G__1049 = null;
var G__1050 = (0);
var G__1051 = (0);
seq__1027_1031 = G__1048;
chunk__1028_1032 = G__1049;
count__1029_1033 = G__1050;
i__1030_1034 = G__1051;
continue;
}
} else {
}
...
return (function (){
if(cljs.core.truth_((function (){var and__4441__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__1056 = script;
goog.object.set(G__1056,"type","text/javascript");

goog.object.set(G__1056,"onload",onload);

goog.object.set(G__1056,"onreadystatechange",onload);

return G__1056;
})();
if((opt_sourceText == null)){
var G__1057 = script__$1;
goog.object.set(G__1057,"src",src);

return G__1057;
} else {
var G__1058 = script__$1;
goog.dom.setTextContext(G__1058,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__4452__auto__ = reload;
...
var path_1059 = goog.debugLoader_.getPathFromDeps_(cljs.core.name);
goog.object.remove(goog.debugLoader_.written_,path_1059);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1059)].join(''));
} else {
var path_1060 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_1060);

goog.object.remove(goog.dependencies_.written,path_1060);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1060)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__1061 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__1062 = repl;
clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__1062;

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__1061;
}})()})));
});})(connected_QMARK_,repl_connection))
);
